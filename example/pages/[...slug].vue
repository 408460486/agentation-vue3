...
// Animated bunny with looking eyes for 404 page
</script>
...
<template>
  <div class="not-found">
    <svg width="64" height="64" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- Animated bunny eyes -->
      <circle class="bunny-eye-left-404" cx="8.277" cy="20.466" r="1.8" fill="rgba(0,0,0,0.2)"/>
      <circle class="bunny-eye-right-404" cx="19.878" cy="20.466" r="1.8" fill="rgba(0,0,0,0.2)"/>
    </svg>
    <p>Page not found.</p>
  </div>
</template>
...
<style>
/* Bunny animation keyframes - must be global for SVG elements */
