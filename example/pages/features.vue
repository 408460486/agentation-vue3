...
<template>
  <article class="article">
    <header>
      <h1>Features</h1>
      <p class="tagline">Everything Agentation can do</p>
    </header>
    ...
    <section>
      ...
      <p>
        Agentation automatically identifies elements in a way that's useful for code search.
      ...
      <table style="width: 100%; border-collapse: collapse; font-size: 0.875rem">
        <tbody>
          <tr>
            ...
            <td style="padding: 0.5rem 0; border-bottom: 1px solid rgba(0,0,0,0.06); color: rgba(0,0,0,0.5); text-align: right">Toggle feedback mode</td>
          </tr>
          <tr>
            <td style="padding: 0.5rem 0; border-bottom: 1px solid rgba(0,0,0,0.06)"><code>Esc</code></td>
            <td style="padding: 0.5rem 0; border-bottom: 1px solid rgba(0,0,0,0.06); color: rgba(0,0,0,0.5); text-align: right">Close toolbar or cancel</td>
          </tr>
          <tr>
            <td style="padding: 0.5rem 0; border-bottom: 1px solid rgba(0,0,0,0.06)"><code>P</code></td>
            <td style="padding: 0.5rem 0; border-bottom: 1px solid rgba(0,0,0,0.06); color: rgba(0,0,0,0.5); text-align: right">Pause/resume animations</td>
          </tr>
          <tr>
            <td style="padding: 0.5rem 0; border-bottom: 1px solid rgba(0,0,0,0.06)"><code>H</code></td>
            <td style="padding: 0.5rem 0; border-bottom: 1px solid rgba(0,0,0,0.06); color: rgba(0,0,0,0.5); text-align: right">Hide/show markers</td>
          </tr>
          <tr>
            <td style="padding: 0.5rem 0; border-bottom: 1px solid rgba(0,0,0,0.06)"><code>C</code></td>
            <td style="padding: 0.5rem 0; border-bottom: 1px solid rgba(0,0,0,0.06); color: rgba(0,0,0,0.5); text-align: right">Copy feedback</td>
          </tr>
          <tr>
            <td style="padding: 0.5rem 0"><code>X</code></td>
            <td style="padding: 0.5rem 0; color: rgba(0,0,0,0.5); text-align: right">Clear all annotations</td>
          </tr>
        </tbody>
      </table>
    ...
    <section>
      ...
      <p>
        ...
        icon lets you customize Agentation to fit your workflow.
      </p>
      <SettingsDemo />
    </section>
    ...
    <section>
      <h2>Limitations</h2>
      <ul>
        <li><strong>Desktop only</strong> — The tool requires a desktop browser, but you can still request mobile changes in your feedback</li>
        <li><strong>Per-page storage</strong> — Annotations persist in localStorage for 7 days</li>
        <li><strong>Single page</strong> — Annotations don't follow across navigation</li>
        <li><strong>Static positions</strong> — Markers don't update if layout changes</li>
        <li><strong>No screenshots</strong> — Output is text-only (paste alongside screenshots if needed)</li>
        <li><strong>CSS animations only</strong> — Pause works on CSS animations, not JS-driven animations (framer-motion, GSAP, etc.)</li>
        <li><strong>React only</strong> — Currently requires React 18+</li>
      </ul>
    </section>
  </article>
</template>
